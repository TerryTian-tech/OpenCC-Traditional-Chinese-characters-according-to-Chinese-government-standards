...
本仓库同时提供了一个Python转换程序，能够实现Word文档（DOC/DOCX）、文本文件（TXT）、电子出版文件（EPUB）和字幕文件（SRT、ASS/SSA、LRC）的繁体字形转换。该程序亦以[OpenCC](https://github.com/BYVoid/OpenCC)作为转换引擎。

## 使用说明
> [!NOTE]
>本仓库的[Releases](https://github.com/TerryTian-tech/OpenCC-Traditional-Chinese-characters-according-to-Chinese-government-standards/releases)下已提供“规范繁体字形转换器”的安装包，支持Win10/Win11/Win7。Ubuntu/Linux Mint已提供deb格式安装包。您可以直接下载安装，如果你需要了解细节，再阅读以下使用说明。
...
> [!NOTE]
>本仓库的[Releases](https://github.com/TerryTian-tech/OpenCC-Traditional-Chinese-characters-according-to-Chinese-government-standards/releases)下已提供“规范繁体字形转换器”的安装包，支持Win10/Win11/Win7。Ubuntu/Linux Mint已提供deb格式安装包。推荐您直接使用已经编译好的安装包。
